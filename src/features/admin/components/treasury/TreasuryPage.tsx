...
export default function TreasuryPage({ businessId }: TreasuryPageProps) {
  ...
  /**
   * Carga las cuentas desde IndexedDB.
   *
   * El worker se encarga previamente de sincronizar
   * servidor <-> IndexedDB.
   */
  ...
  /**
   * Inicialización de Tesorería.
   *
   * Primero sincronizamos:
   *
   *   servidor <-> IndexedDB
   *
   * y después cargamos IndexedDB para mostrar la información.
   */
  useEffect(() => {
